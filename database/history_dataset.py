...
if __name__=='__main__':
    ...
    symbols = ['AAPL','CSCO','INTC','ORCL','MSFT','IBM','HON','VZ','MFC','JPM','BAC','TD','MMM','CAT','BA','GE','WMT','KO', 'HD','AMZN','JNJ','MRK','PFE','GILD','ENB','CVX','BP']
    data = download_data(symbols)
    prepeared_df = process_data(data,number_of_stocks=len(symbols))
    # db_create("postgresql+psycopg2://postgres:1234@localhost:5432/diplomski", prepeared_df)
    db_create("postgresql+psycopg2://xblong:1234@localhost:5432/diplomski", prepeared_df)
