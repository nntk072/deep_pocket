    ...
    with torch.autograd.set_detect_anomaly(True):
        for i in tqdm(range(num_episodes)):
            ...
            while not done:
                ...
                obs_, reward, done, _, info = env.step(weights.detach().numpy())
...
def get_args():
    ...
    parser.add_argument('--assets_number', type = int, default = 27, help='number of assets')
    ...
    parser.add_argument('--buffer_size', type = int, default = 1000,help='size of buffer containg data')
    # parser.add_argument('--database_url',type = str, default = 'postgresql+psycopg2://postgres:1234@localhost:5432/diplomski', help='database url to save/load data')
    parser.add_argument('--database_url',type = str, default = 'postgresql+psycopg2://xblong:1234@localhost:5432/diplomski', help='database url to save/load data')
